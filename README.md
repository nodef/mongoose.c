...
Mongoose is a network library for C/C++, by [Cesanta Software](https://github.com/cesanta).
...
And then include `mongoose.h` as follows:
```c
#include "node_modules/mongoose.c/mongoose.h"
```

You may also want to include `mongoose.c` as follows:
```c
#ifndef __MONGOOSE_C__
#define __MONGOOSE_C__
#include "node_modules/mongoose.c/mongoose.c"
#endif
```
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/mongoose.c)
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/cesanta/mongoose)
